...
})({"hor7Q":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
...
var _fetchWrapperJs = require("./fetch_wrapper.js");
var _fetchWrapperJsDefault = parcelHelpers.interopDefault(_fetchWrapperJs);
// Snackbar
...
const API = new _fetchWrapperJsDefault.default("https://firestore.googleapis.com/v1/projects/programmingjs-90a13/databases/(default)/documents/");
const getFoodData = ()=>{
...
const addFood = (e)=>{
    ...
    if (foodName !== "Please select" && inputCarbs && inputProtein && inputFat) {
        _snackbarDefault.default.duration = 2500;
        _snackbarDefault.default.show("Food data added successfully.");
        blankChart.destroy();
        ...
        _snackbarDefault.default.duration = 3500;
        _snackbarDefault.default.show("Something's not right. Please complete all fields");
    }
    form.reset();
};
...
},{"./fetch_wrapper.js":"bFiLb","snackbar":"60sYh","snackbar/dist/snackbar.min.css":"gJlwf","chart.js/auto":"f3sfP","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"bFiLb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["hor7Q","29JuH"], "29JuH", "parcelRequire204f")
